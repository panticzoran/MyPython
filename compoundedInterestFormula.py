...
newPrincipalSum = originalPrincipalSum * (1 + nominalAnnualInterestRate/compoundingFrequency)**(compoundingFrequency * t)
...
toInvest = 88000
fnl = final_amt(toInvest, 0.0724/12, 12, 15.5)  # for 7.24% interest, compounded 12 times per year, for 15.5 years

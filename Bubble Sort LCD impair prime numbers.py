...
# Print the result
print("The lowest common denominator of", a, "and", b, "is", lowestCommonDenominator(a, b))
print("\n")
...
print("The average of all impair numbers from 1 to", number, "is", averageOfAllImpairNumbers(number))
print("\n")
...
number = int(input("Enter the number: "))
print("The sum of all prime numbers from 1 to", number, "is", sumOfAllPrimeNumbers(number))
print("\n")
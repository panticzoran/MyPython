...
print("The number of appearances of the character '", charInput, "' in the string ", textInput, "' is ", countAppearances(textInput,charInput))
...
charInput = input("Please enter the character to be searched for ")
fromIndex = 0
print("The character '", charInput, "' appears in the string'", textInput, 
			"' on the folowing places", end=": ")

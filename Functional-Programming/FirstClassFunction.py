# Exploring First-Class Functions, creating a function that accepts another function as
# an argument and a list, applying the function to each element in the list

def applyFunction(functionToAppl, listToBeAppliedTo):
  return [functionToAppl(item) for item in listToBeAppliedTo]
